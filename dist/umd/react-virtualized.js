    ...
    function(module, exports, __webpack_require__) {
        ...
        function defaultCellGroupRenderer(_ref5) {
            ...
            return indices.map(function(index) {
                var cellMetadata = void 0, renderedCell = void 0;
                return isScrolling ? index in renderedCellCache ? (renderedCell = renderedCellCache[index], 
                cellMetadata = cellMetadataCache[index]) : (cellMetadataCache[index] = cellSizeAndPositionGetter({
                    index: index
                }), renderedCellCache[index] = cellRenderer({
                    index: index,
                    isScrolling: isScrolling
                })) : (cellMetadata = cellSizeAndPositionGetter({
                    index: index
                }), renderedCell = cellRenderer({
                    index: index,
                    isScrolling: isScrolling
                })), null == renderedCell || renderedCell === !1 || null == cellMetadata || cellMetadata === !1 ? null : _react2["default"].createElement("div", {
